...
async function main() {
  console.log("===========================================");
  console.log("Testing on 3 posts");
  console.log("===========================================\n");

  const testSlugs = [
    "capex-software-vs-spreadsheets",
    "construction-cost-estimating-tips",
  ...
  for (const slug of testSlugs) {
    ...
    if (!content || content.length === 0) {
      console.log("  No content found from Webflow");
      continue;
    }
    ...
    content.slice(0, 5).forEach((block: any, i: number) => {
      ...
      console.log(`    ${i + 1}. [${block.style}${block.listItem ? '/' + block.listItem : ''}] ${text.substring(0, 60)}...`);
    });
  ...
  console.log("\n===========================================");
  console.log("Test complete - check the posts on the site");
  console.log("===========================================");
}
