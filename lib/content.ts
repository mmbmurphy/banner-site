...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        quote: "We went from managing 5 projects to 15 without adding a single person to the team. Banner gives us the visibility to be proactive instead of reactive—and our investors notice the difference.",
        author: "Rachel Kim",
